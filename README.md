...
The biggest chalange was the PCB - I started learning how to make one in KiCad, but I ended up using EasyEDA because in my opinion it is a bit more user-friendly.
